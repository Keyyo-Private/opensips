...
extern inline int con_set_inslist(db_func_t *dbf,db_con_t *con,query_list_t **list,
							db_key_t *cols,int col_no);
void ql_timer_routine(unsigned int ticks,void *param);
extern inline int ql_flush_rows(db_func_t *dbf,db_con_t *conn,query_list_t *entry);
